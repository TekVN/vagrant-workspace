...
rabbitmqctl add_user workspace secret
rabbitmqctl set_user_tags workspace administrator
rabbitmqctl set_permissions -p / workspace ".*" ".*" ".*"
rabbitmqctl set_topic_permissions -p / workspace ".*" ".*" ".*"
